...
class HomeViewController:MNkViewController,FireAuthAccessible {
    ...
    override func createViews() {
        ...
        secoendSV = UIStackView.init(arrangedSubviews: [locationButton, aboutButton])
        secoendSV.axis = .horizontal
        secoendSV.spacing = 8
        secoendSV.distribution = .fillEqually
        
        mainSV = UIStackView.init(arrangedSubviews: [firstSV, secoendSV])
    ...
    override func insertAndLayoutSubviews() {
        ...
        scrollView.activateLayouts(to: view, [.top:20,.leading:0,.traling:0,.bottom:0], true)
